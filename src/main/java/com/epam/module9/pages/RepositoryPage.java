...
import com.epam.module9.exception.EmptyListOfWebElementsException;
...
public class RepositoryPage {
    ...
    private RepositoryPage clickReadmeLink() {
        if (weRecommendEveryRepositoryIncludeLine.isEmpty()){
            System.out.println("'weRecommendEveryRepositoryIncludeLine' list is empty or WebElement path is invalid");
        }
